...
b50 = tk.Button(app, text='Start', font=("Arial", 13), command=lambda: start_whole_camera(values), bg='red')
b50.grid(row=0, column=1, sticky=tk.W, pady=4)
