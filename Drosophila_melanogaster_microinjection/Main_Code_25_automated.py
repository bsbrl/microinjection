...
# Initial Variables
# small dish height and light should be 1.5 intensity, 6 for regular
z_needle=16000
# z_needle=19000
Z_initial=z_needle+3000      
width_image=6000
height_image=4000
thresh_ml=.1
...
# take picture
filename='Entire_Petri_Dish_1051.jpg'
...
xc_rc,yc_rc,scores=ml('C:/Users/me-alegr011-admin/Downloads/Robot_code/faster_r_cnn_trained_model_petri_new_8','C:/Users/me-alegr011-admin/Downloads/Robot_code/DSLR_Camera/'+filename,thresh_ml,width_image,height_image)
...
cv2.imwrite('C:/Users/me-alegr011-admin/Downloads/Robot_code/Video images/ML_image/'+filename,img_dish)
...
with graph.as_default():
    with tf.compat.v1.Session() as sess:
        ...
        print(len(positions))
        img_dish=cv2.imread('C:/Users/me-alegr011-admin/Downloads/Robot_code/Video images/ML_image/'+filename,1)
