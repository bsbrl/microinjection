...
def ml_injection_point_estimation_new_cody(image,ml_threshold,im_height,im_width,detection_graph,sess,step):   
...
#    IMAGE_SIZE = (5, 5)
    ...
    for f in range(len(output_dict_detection_boxes_stored)):
        if len(output_dict_detection_boxes_stored[f])!=0:
            ...
            for i in range(len(output_dict_detection_boxes_stored[f])):
                ...
                detection_coords_classes_all.append([y1,y2,x1,x2,output_dict_detection_classes_stored[f][i]])
    ...
    return output_dict_detection_boxes_stored, output_dict_detection_classes_stored, output_dict_detection_scores_stored, y1a_rc_list, y2a_rc_list, x1a_rc_list, x2a_rc_list, xc_rc_list, yc_rc_list,detection_coords_classes_all
...
# img1 = cv2.imread('C:/Users/User/Downloads/Andrew_files/Amey Code-20190710T183750Z-001/Amey Code/img_1_2.jpg', 1)
# BLUE = [255,255,255]
# constant= cv2.copyMakeBorder(img1,200,0,0,0,cv2.BORDER_CONSTANT,value=BLUE)
# cv2.imwrite('C:/Users/User/Downloads/Andrew_files/Amey Code-20190710T183750Z-001/Amey Code/img_2_3.jpg', constant)
# img1 = cv2.imread('C:/Users/User/Downloads/Andrew_files/Amey Code-20190710T183750Z-001/Amey Code/img_2_3.jpg', 1)
...
#   # with tf.compat.v2.io.gfile.GFile('C:/Users/User/Downloads/faster_r_cnn_trained_model_cody'+'/frozen_inference_graph.pb', 'rb') as fid:
...
#             output_dict_detection_boxes_stored, output_dict_detection_classes_stored, output_dict_detection_scores_stored, y1a_rc, y2a_rc, x1a_rc, x2a_rc, xc_rc, yc_rc = ml_injection_point_estimation_new(img1_list, thresh_ml, 800, 800, graph, sess, 1)
...
# plt.figure(2)
# plt.title('Detected Points FOV1')
# plt.xlabel('x coordinate (px)')
# plt.ylabel('y coordinate (px)')
# plt.plot(xc_rc[0][3], yc_rc[0][3], 'ro', markersize=4)
# #plt.plot(xc_rc[1],yc_rc[1],'bo',markersize=4)
# #plt.plot(xc_rc[2],yc_rc[2],'co',markersize=4)
